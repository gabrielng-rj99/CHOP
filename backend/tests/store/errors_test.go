...
func TestNewValidationError(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ve := store.NewValidationError(tt.message, tt.err)
			if ve.Error() != tt.want {
...
func TestValidationErrorError(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ve := store.NewValidationError(tt.message, tt.innerErr)
			if ve.Error() != tt.want {
				t.Errorf("expected '%s', got '%s'", tt.want, ve.Error())
			}
		})
...
func TestIsValidationError(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			err:          store.NewValidationError("test error", nil),
			isValidation: true,
		},
		{
			name:         "validation error with wrapped error returns true",
			err:          store.NewValidationError("test error", errors.New("inner")),
			isValidation: true,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := store.IsValidationError(tt.err)
...
func TestValidationErrorChain(t *testing.T) {
	...
	ve := store.NewValidationError("validation failed", innerErr)
...
func TestValidationErrorImplementsError(t *testing.T) {
	ve := store.NewValidationError("test", nil)
	var _ error = ve
