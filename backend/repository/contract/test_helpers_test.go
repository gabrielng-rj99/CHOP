...
// NewSubcategoryStore creates a new SubcategoryStore for testing
func NewSubcategoryStore(db repository.DBInterface) *categorystore.SubcategoryStore {
	return categorystore.NewSubcategoryStore(db)
}

// NewClientStore creates a new ClientStore for testing
func NewClientStore(db repository.DBInterface) *clientstore.ClientStore {
