...
### GET /api/audit-logs/resource/{resource}/{resourceID}
 ...
 | ----------- | ------- | -------- | --------- | 
 | **Auth** | Sem token | ⬜ | - | 
 | **Path Traversal** | resource com ../ | ⬜ | - | 
 | **SQL Injection** | resource/resourceID | ⬜ | - | 
...
### POST /api/upload
 ...
 | ----------- | ------- | -------- | --------- | 
 | **Auth** | Sem token | ⬜ | - | 
 | **File Type** | MIME type inválido | ⬜ | - | 
 | **File Size** | > 15MB | ⬜ | - | 
 | **Malicious File** | SVG com script | ⬜ | - | 
 | **Path Traversal** | Filename com ../ | ⬜ | - | 
...
### POST /api/deploy/config
 ...
 | Categoria | Teste | Status | Arquivo | 
 | ----------- | ------- | -------- | --------- | 
 | **Auth** | Sem deploy token | ⬜ | - | 
 | **Auth** | Token inválido | ⬜ | - | 
 | **SQL Injection** | Config values | ⬜ | - | 
 | **XSS** | Config values | ⬜ | - | 
